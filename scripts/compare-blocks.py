...
BLOCKS = [
    ...
    ('#chto-ocenivayut', 'Что на самом деле происходит на секции',
     'Новый блок: конвейер из пяти шагов на официальных требованиях Яндекса. Подписи рядов вынесены слева, шаги проявляются по очереди при скролле. Внизу — переход к программе через противопоставление: на секции один заход, до неё пять недель.'),
