...
BLOCKS = [
    ...
    ('#chto-ocenivayut', 'Что на самом деле происходит на секции',
     'Новый блок: маршрут секции одной сеткой — что делает интервьюер, где на этом шаге ломаются, в каком уроке чиним. Мост от болей к программе. Цитата про «не самые умные» осталась в светлом островке, здесь её нет.'),
